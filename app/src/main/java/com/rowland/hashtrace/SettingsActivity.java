...
public class SettingsActivity extends PreferenceActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_hashtag_key)));
	...
	public boolean onPreferenceChange(Preference preference, Object value) {
		...
		if (!mBindingPreference) {
			if (preference.getKey()
					.equals(getString(R.string.pref_hashtag_key))) {
				TweetHashTracerSyncAdapter.syncImmediately(this);
			} else {
				// notify code that tweet may be impacted
				getContentResolver().notifyChange(
						TweetHashTracerContract.TweetEntry.CONTENT_URI, null);
			}
		}
