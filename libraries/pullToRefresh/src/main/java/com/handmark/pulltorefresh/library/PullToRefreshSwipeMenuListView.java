...
/**
 * Class to combine features of pullToRefresh Library and SwipeMenuList library
 *
 * @author Rowland
 *
 */
public class PullToRefreshSwipeMenuListView extends PullToRefreshAdapterViewBase<SwipeMenuListView> {
	...
	{
		mRefreshableView.setOnMenuItemClickListener(listener);
	}

	public void setMenuCreator(SwipeMenuCreator menuCreator)
	{
		mRefreshableView.setMenuCreator(menuCreator);
	}
	public void smoothOpenMenu(int position)
	{
		mRefreshableView.smoothOpenMenu(position);
	}

	public void setCloseInterpolator(BounceInterpolator bounceInterpolator)
	{
		mRefreshableView.setCloseInterpolator(bounceInterpolator);
	}
	public void setOpenInterpolator(BounceInterpolator bounceInterpolator)
	{
		mRefreshableView.setOpenInterpolator(bounceInterpolator);
	}
	...
	{
		return mRefreshableView.getChildAt(position);
